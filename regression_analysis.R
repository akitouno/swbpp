...
numeric_vars <- c('income', 'education_mother', 'education_father', 'pubertal_stage', 'iq', 'aspiration', 
                  'self_control', 'prosocial_behavior', 'sibling', 'grand_parent', 'life_satisfaction_of_caregiver', 
                  'talk_with_caregiver', 'cooperative_spouse_in_childcare', 
                  'satisfied_with_family', 'want_to_be_like_mother', 'want_to_be_like_father',  
                  'caregiver_interferes_of_future_work', 'caregiver_life_plan_is_stability_oriented',
...
selected_vars <- c('sex', 'primary_caregiver', 'ethnic_minority', 'income', 'education_mother', 'education_father', 
                   ...
                   'kindergarten_entrance_exam', 'elementary_school_entrance_exam', 'tutoring_school',
                   'chronic_health_problems', 'special_needs', 'overweight', 
                   'separation_mother', 'separation_father', 'sibling', 'elder_sibling', 'grand_parent',  
                   ...
                   'want_to_be_like_mother', 'want_to_be_like_father', 'caregiver_interferes_of_future_work', 'caregiver_life_plan_is_stability_oriented', 
...
equation <- 'class_parallel_process_lcga~sex+ethnic_minority+income+education_mother+education_father+pubertal_stage+iq+aspiration+self_control+prosocial_behavior+kindergarten_entrance_exam+elementary_school_entrance_exam+tutoring_school+chronic_health_problems+special_needs+overweight+separation_mother+separation_father+sibling+elder_sibling+grand_parent+smoker_in_household+life_satisfaction_of_caregiver+chronic_health_problems_mother+chronic_health_problems_father+cooperative_spouse_in_childcare+satisfied_with_family+talk_with_caregiver+want_to_be_like_mother+want_to_be_like_father+caregiver_interferes_of_future_work+caregiver_life_plan_is_stability_oriented+like_school+social_relationships_outside_school+good_neighborhood_for_childcare+neighborhood_cohesion_and_trust'
